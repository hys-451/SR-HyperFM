...
def parse_args():
    ...
    parser.add_argument('--model_type', type=str, default='SRFM')
    ...
    parser.add_argument('--ks', type=str2list, default=[39, 10, 5], help='the size of sampled neighborhood')
    ...
    parser.add_argument('--data', type=str, default='Criteo', help='data name')
    parser.add_argument('--data_path', type=str, default='\data', help='root path for all the data')
    parser.add_argument('--hypergraph_sample', type=bool, default=True, help='Use sample hypergraph')
    parser.add_argument('--hypergraph_feature', type=bool, default=True, help='Use feature hypergraph')
    parser.add_argument('--hyperedge_num', type=int, default=50, help='Number of hyperedges for feature hypergraph')
...
def _run_(args, file_name, run_cnt):
    ...
    elif args.model_type == 'SRFM':
        model = SRFM(args=args, feature_size=feature_size, run_cnt=run_cnt)
